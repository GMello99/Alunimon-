...
ayres = Pokemon("ayres.png", 150, 40,0,1,"ayres")
vitor = Pokemon("vitor.png", 150, 40,0,1,"vitor")
pelicano = Pokemon("pelicano.png", 150, 40,0,1,"pelicano")
fernando = Pokemon("fernando.png", 150, 40,0,1,"fernando")
daniel = Pokemon("daniel.png", 150, 40,0,1,"daniel")
bobrow = Pokemon("bobrow.png", 150, 40,0,1,"bobrow")
...
Fundo = pygame.image.load("fundo_batalha.jpg").convert()
vitoria = pygame.image.load("vitoria_batalha.jpg").convert()
